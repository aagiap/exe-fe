...
const Cart = () => {
    ...
    const fetchCart = async () => {
        try {
            setLoading(true);
            const response = await axios.get('https://exe-be-9wd4.onrender.com/api/api/cart', axiosConfig);
    ...
    const handleUpdateQuantity = async (productId, newQuantity) => {
        ...
        try {
            const response = await axios.put(
                `https://exe-be-9wd4.onrender.com/api/cart/item/${productId}`,
                null,
    ...
    const handleDeleteItem = async (productId) => {
        ...
        try {
            const response = await axios.delete(`https://exe-be-9wd4.onrender.com/api/cart/item/${productId}`, axiosConfig);
            if (response.data.success) {
                setCart(response.data.data);
